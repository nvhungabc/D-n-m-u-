      ...
      <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
          <ul id="sidebarnav" class="p-t-30">
            ...
            <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fa-sharp fa-solid fa-comments"></i></i><span class="hide-menu">THỐNG KÊ </span></a>
              <ul aria-expanded="false" class="collapse  first-level">
                <li class="sidebar-item"><a href="index2.php?url=thong_ke" class="sidebar-link"><i class="mdi mdi-note-outline"></i><span class="hide-menu">DANH SÁCH </span></a></li>
              </ul>
            </li>
            </li>
                            ...
                            <table class="table">
                                  ...
                                  <?php foreach ($ds_xe as $key => $value) : ?>
                                    <tr >
                                      ...
                                      <td style="padding-top: 60px;"><?= $value['price'] ?></td>
                                      <td style="padding-top: 60px;"><?= $value['ma_loai'] ?></td>
                                      <td style="padding-top: 60px;"> <img src="<?= $value['image'] ?>" alt="" width="100%"></td>
                                      <td style="padding-top: 60px;"><?= $value['detail'] ?></td>
