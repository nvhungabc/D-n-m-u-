                            ...
                            <form class="form-horizontal"  method="POST" enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control"  placeholder="Nhập Đơn Giá" name="price" value="<?= $sua['price'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Thông Tin</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control"  placeholder="Nhập Thông Tin" name="detail" value="<?= $sua['detail'] ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <img src="<?= $sua['image'] ?>" alt="" width="20%">
                                        </div>
                                    </div>
                                    <div class="form-group row">
